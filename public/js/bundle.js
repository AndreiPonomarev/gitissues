...
var SearchbarActions = function () {
  function SearchbarActions() {
    ...
    this.generateActions('updateSearchQuery', 'findIssuesSuccess', 'findIssuesFail');
  }

  _createClass(SearchbarActions, [{
    key: 'findIssues',
    value: function findIssues(payload) {
      var _this = this;
      var xhr = new XMLHttpRequest();
      var url = 'https://api.github.com/repos/' + payload.searchForm[0].value + '/' + payload.searchQuery + '/issues';
...
},{"./Searchbar":6,"react":"react"}],5:[function(require,module,exports){
'use strict';
...
var Home = function (_React$Component) {
  ...
  _createClass(Home, [{
    ...
    key: 'render',
    value: function render() {
      var IssuesNodes = this.state.issues.map(function (issue) {
        console.log(_typeof(issue.created_at));
        return _react2.default.createElement(
          'tr',
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          ...
          _react2.default.createElement(
            'table',
            { className: 'isuue-table' },
            _react2.default.createElement(
              'thead',
              null,
              _react2.default.createElement(
                'tr',
                { key: 'issue-table-head' },
                ' ',
                _react2.default.createElement(
                  'th',
                  { id: 'issue-id' },
...
},{"../actions/HomeActions":1,"../stores/HomeStore":9,"../stores/SearchbarStore":10,"react":"react","react-router":"react-router"}],6:[function(require,module,exports){
'use strict';
...
var Searchbar = function (_React$Component) {
  ...
  _createClass(Searchbar, [{
    ...
    value: function handleSubmit(event) {
      ...
      if (searchQuery) {
        _SearchbarActions2.default.findIssues({
    ...
    value: function render() {
      return _react2.default.createElement(
        ...
        _react2.default.createElement(
          'form',
          { ref: 'searchForm', className: 'navbar-form', onSubmit: this.handleSubmit.bind(this) },
          _react2.default.createElement(
            'div',
...
},{"../actions/SearchbarActions":2,"../stores/SearchbarStore":10,"react":"react","react-router":"react-router"}],7:[function(require,module,exports){
'use strict';
...
},{"./components/Searchbar":6,"./routes":8,"history/lib/createBrowserHistory":17,"react":"react","react-dom":"react-dom","react-router":"react-router"}],8:[function(require,module,exports){
'use strict';
...
var SearchbarStore = function () {
  ...
  _createClass(SearchbarStore, [{
    key: 'onFindIssuesSuccess',
    value: function onFindIssuesSuccess(payload) {
      this.issues = payload;
    }
  }, {
    key: 'onFindIssuesFail',
    value: function onFindIssuesFail(payload) {
...
},{"../actions/SearchbarActions":2,"../alt":3}],11:[function(require,module,exports){
...
},{"./Actions":12,"./DOMStateStorage":14,"./DOMUtils":15,"./ExecutionEnvironment":16,"./createDOMHistory":18,"./parsePath":23,"_process":11,"invariant":28}],18:[function(require,module,exports){
(function (process){
'use strict';
